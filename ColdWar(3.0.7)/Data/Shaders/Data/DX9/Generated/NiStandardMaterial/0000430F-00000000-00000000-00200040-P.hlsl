#line 2 "D:\게임브리오\Gamebryo 2.2 Source\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\0000430F-00000000-00000000-00200040-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(g_MaterialEmissive, Color_CallOut6, Opacity_CallOut6);
    ...
    ComputeShadingCoefficients(Color_CallOut6, float3(1.0, 1.0, 1.0), 
    ...
    MultiplyFloat3(Diffuse_CallOut8, Color_CallOut7, Output_CallOut11);

	// Function call #12
    float Output_CallOut12;
    MultiplyFloat(Opacity_CallOut6, Opacity_CallOut7, Output_CallOut12);

	// Function call #13
    float3 Output_CallOut13;
    AddFloat3(Output_CallOut11, ColorOut_CallOut5, Output_CallOut13);
    ...
    CompositeFinalRGBColor(Output_CallOut13, Specular_CallOut8, 
