#line 2 "D:\게임브리오\Gamebryo 2.2 Source\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\03000001-00000800-00000000-00090000-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    AddFloat3(ColorOut_CallOut2, In.SpecularAccum, Output_CallOut3);

	// Function call #4
    float3 OutputColor_CallOut4;
    CompositeFinalRGBColor(Output_CallOut1, Output_CallOut3, 
        OutputColor_CallOut4);

	// Function call #5
    CompositeFinalRGBAColor(OutputColor_CallOut4, Opacity_CallOut0, Out.Color);
