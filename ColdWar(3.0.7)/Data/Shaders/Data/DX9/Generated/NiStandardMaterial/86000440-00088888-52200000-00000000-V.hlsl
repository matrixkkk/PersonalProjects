#line 2 "d:\Á¹¾÷ ¿¬±¸\Á¹ÀÛ\ColdWar(2.8)(¼­¹ö)\Data\Shaders\Data\DX9\Generated\\NiStandardMaterial\86000440-00088888-52200000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
	...
	// Function call #6
    float3 WorldNrm_CallOut6;
    TransformNormal(In.Normal, g_World, WorldNrm_CallOut6);

	// Function call #7
    float3 VectorOut_CallOut7;
    NormalizeFloat3(WorldNrm_CallOut6, VectorOut_CallOut7);
    ...
    SplitColorAndOpacity(g_MaterialDiffuse, Color_CallOut10, Opacity_CallOut10);
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut7, int(0), bool(false), 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut10, 
	...
	// Function call #15
    CompositeFinalRGBAColor(Diffuse_CallOut14, Opacity_CallOut10, 
        Out.DiffuseAccum);
