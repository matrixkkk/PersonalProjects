#line 2 "D:\게임브리오\Gamebryo 2.2 Source\Sdk\Win32\Shaders\Data\DX9\\Generated\\NiStandardMaterial\00001941-00000000-52008000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    ProjectTextureCoordinates(WorldReflect_CallOut7, 
        g_EnvironmentMapWorldProjectionTransform0, Out.UVSet0);
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        ...
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
        AmbientAccumOut_CallOut6, DiffuseAccumOut_CallOut6, 
        SpecularAccumOut_CallOut6, AmbientAccumOut_CallOut9, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition6, g_PointAmbient6, 
        g_PointDiffuse6, g_PointSpecular6, g_PointAttenuation6, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(true), float(1.0), 
        WorldViewVector_CallOut5, g_PointWorldPosition7, g_PointAmbient7, 
        g_PointDiffuse7, g_PointSpecular7, g_PointAttenuation7, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), g_MaterialPower, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        g_MaterialAmbient, g_MaterialSpecular, SpecularAccumOut_CallOut15, 
        DiffuseAccumOut_CallOut15, AmbientAccumOut_CallOut15, bool(false), 
        Diffuse_CallOut16, Out.SpecularAccum);

	// Function call #17
    CompositeFinalRGBAColor(Diffuse_CallOut16, Opacity_CallOut2, 
        Out.DiffuseAccum);
