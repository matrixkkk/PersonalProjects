#line 2 "D:\게임브리오\Gamebryo 2.2 Source\Samples\FullDemos\MOUT\Data\Shaders\Generated\NiStandardMaterial\81001840-00000000-5B101000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut1, VectorOut_CallOut5, int(1), bool(false), 
    ...
    WorldReflect(WorldNrm_CallOut4, WorldViewVector_CallOut6, 
        WorldReflect_CallOut8);

	// Function call #9
    ProjectTextureCoordinates(WorldReflect_CallOut8, 
    ...
    Light(WorldPos_CallOut1, VectorOut_CallOut5, int(0), bool(false), 
