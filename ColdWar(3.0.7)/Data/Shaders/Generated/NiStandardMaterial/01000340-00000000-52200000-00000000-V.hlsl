#line 2 "d:\게임브리오\ColdWa(2.4)\Data\Shaders\Generated\NiStandardMaterial\01000340-00000000-52200000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut5, int(0), bool(true), float(1.0), 
        WorldViewVector_CallOut6, g_DirWorldPosition0, g_DirAmbient0, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut5, int(0), bool(true), float(1.0), 
        WorldViewVector_CallOut6, g_DirWorldPosition, g_DirAmbient, 
