#line 2 "c:\Documents and Settings\김현구\바탕 화면\게임브리오\ColdWar\Data\Shaders\Generated\NiStandardMaterial\01000040-00000000-43200000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(g_MaterialEmissive, Color_CallOut3, Opacity_CallOut3);

	// Function call #4
    float3 Diffuse_CallOut4;
    float3 Specular_CallOut4;
    ComputeShadingCoefficients(Color_CallOut3, float3(1.0, 1.0, 1.0), 
	...
	// Function call #5
    CompositeFinalRGBAColor(Diffuse_CallOut4, Opacity_CallOut3, 
        Out.DiffuseAccum);
