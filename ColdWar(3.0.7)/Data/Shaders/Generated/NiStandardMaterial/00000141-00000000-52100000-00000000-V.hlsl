#line 2 "D:\게임브리오\Gamebryo 2.2 Source\Samples\Demos\ObjectPick\Data\Shaders\Generated\NiStandardMaterial\00000141-00000000-52100000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        g_MaterialAmbient, g_MaterialSpecular, SpecularAccumOut_CallOut6, 
        DiffuseAccumOut_CallOut6, AmbientAccumOut_CallOut6, bool(false), 
        Diffuse_CallOut7, Out.SpecularAccum);

	// Function call #8
    CompositeFinalRGBAColor(Diffuse_CallOut7, Opacity_CallOut2, 
        Out.DiffuseAccum);
