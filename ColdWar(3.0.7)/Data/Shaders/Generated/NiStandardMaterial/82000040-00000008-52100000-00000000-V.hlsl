#line 2 "c:\Documents and Settings\김현구\바탕 화면\게임브리오\ColdWar\Data\Shaders\Generated\NiStandardMaterial\82000040-00000008-52100000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
	...
	// Function call #9
    CompositeFinalRGBAColor(Diffuse_CallOut8, Opacity_CallOut6, 
        Out.DiffuseAccum);
