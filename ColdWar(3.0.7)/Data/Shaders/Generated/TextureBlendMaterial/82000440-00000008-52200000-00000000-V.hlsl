#line 2 "d:\게임브리오\ColdWa(2.5)\Data\Shaders\Generated\TextureBlendMaterial\82000440-00000008-52200000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(g_MaterialDiffuse, Color_CallOut7, Opacity_CallOut7);

	// Function call #8
    float3 AmbientAccumOut_CallOut8;
    float3 DiffuseAccumOut_CallOut8;
    float3 SpecularAccumOut_CallOut8;
    Light(WorldPos_CallOut0, VectorOut_CallOut5, int(0), bool(false), 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut7, 
	...
	// Function call #11
    CompositeFinalRGBAColor(Diffuse_CallOut10, Opacity_CallOut7, 
        Out.DiffuseAccum);
