#line 2 "e:\Á¹¾÷ ¿¬±¸\ColdWa(2.4)\Data\Shaders\Generated\TextureBlendMaterial\84000440-00000888-52200000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    SplitColorAndOpacity(g_MaterialDiffuse, Color_CallOut8, Opacity_CallOut8);
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut6, int(0), bool(false), 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut8, 
	...
	// Function call #13
    CompositeFinalRGBAColor(Diffuse_CallOut12, Opacity_CallOut8, 
        Out.DiffuseAccum);
